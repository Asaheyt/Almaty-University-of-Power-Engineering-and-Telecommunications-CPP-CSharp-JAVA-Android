    ...
    class MyForm1 : Form {
        ...
        private void OK_Click(object sender, EventArgs arg) {
            try
            {
                ...
                string sqlExpression = "INSERT INTO Table_1 (IHL, Dir, Cat, ML, BW) VALUES ('"+Convert.ToString(tIOHL.Text)+ "',' " + Convert.ToString(tDir.Text) + "',' " + Convert.ToInt32(tCat.Text) + "', 'C#', '2015-09-19')";
